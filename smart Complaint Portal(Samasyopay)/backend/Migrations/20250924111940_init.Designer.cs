            ...
            modelBuilder.Entity("Complaint_2._0.Models.Complaint", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            CitizenId = 1,
                            ComplaintTypeId = 2,
                            CreatedAt = new DateTime(2025, 9, 24, 10, 5, 0, 0, DateTimeKind.Unspecified),
                            Description = "Name mismatch in Voter ID",
                            Status = 0,
                            Title = "Voter ID Name Mismatch",
                            UpdatedAt = new DateTime(2025, 9, 24, 10, 5, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("Complaint_2._0.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Name = "John Citizen",
                            PasswordHash = "AQAAAAEAACcQAAAAEFakeHash1",
                            Role = 0
                        },
                        new
                        {
                            ...
                            Name = "Agent Smith",
                            PasswordHash = "AQAAAAEAACcQAAAAEFakeHash2",
                            Role = 1
                        });
                });
            ...
            modelBuilder.Entity("Complaint_2._0.Models.Complaint", b =>
                {
                    ...
                    b.HasOne("Complaint_2._0.Models.User", null)
                        .WithMany("ComplaintsAsAgent")
                        .HasForeignKey("UserId");

                    b.HasOne("Complaint_2._0.Models.User", null)
                        .WithMany("ComplaintsAsCitizen")
            ...
            modelBuilder.Entity("Complaint_2._0.Models.User", b =>
                {
                    ...
                    b.Navigation("ComplaintsAsAgent");

                    b.Navigation("ComplaintsAsCitizen");
                });
